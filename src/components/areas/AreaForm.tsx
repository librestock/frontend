      ...
      <FieldGroup>
          ...
          {(field) => (
            <Field>
              <FieldLabel htmlFor={field.name}>
                {t('areas.name', { defaultValue: 'Name' })}
              </FieldLabel>
              <FieldContent>
                <Input
        ...
        <form.Field name="code">
          {(field) => (
            <Field>
              <FieldLabel htmlFor={field.name}>
                {t('areas.code', { defaultValue: 'Code' })}
              </FieldLabel>
              <FieldContent>
                <Input
                  aria-invalid={field.state.meta.errors.length > 0}
        ...
        <form.Field name="description">
          {(field) => (
            <Field>
              <FieldLabel htmlFor={field.name}>
                {t('areas.description', { defaultValue: 'Description' })}
              </FieldLabel>
              <FieldContent>
                <Textarea
                  aria-invalid={field.state.meta.errors.length > 0}
        ...
        <form.Field name="parent_id">
          {(field) => (
            <Field>
              <FieldLabel htmlFor={field.name}>
                {t('areas.parentArea', { defaultValue: 'Parent Area' })}
              </FieldLabel>
              <FieldContent>
                <Select
                ...
                >
                  <SelectTrigger>
                    <SelectValue
                      placeholder={t('areas.noParent', { defaultValue: 'No Parent (Root)' })}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="none">
                      {t('areas.noParent', { defaultValue: 'No Parent (Root)' })}
                    </SelectItem>
        ...
        <form.Field name="is_active">
          {(field) => (
            <Field>
              <FieldLabel htmlFor={field.name}>
                {t('areas.status', { defaultValue: 'Status' })}
              </FieldLabel>
              <FieldContent>
                <BooleanSelect
